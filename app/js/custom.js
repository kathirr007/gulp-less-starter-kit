...
define(['jquery', 'jquery/ui', 'slick', 'mage/translate'], function ($) {
  ...
  function remapUrl() {
    ...
    $('li.About.Us a').attr({
      'href': 'https://www.hbftextiles.com/about/abouthbftextiles',
      'target': '_blank'
    });
    $('li.Designers a').attr('href', '/designers');
    $('.Corporate.Social.Responsibility a').attr('href', '/corporate-social-responsibility');
    $('li.Find.a.Rep a').attr({
      'href': 'https://www.hbftextiles.com/about/findarep',
      'target': '_blank'
    });
    $('li.Contact a').attr('href', '/contact');
    $('li.Showrooms a').attr({
      'href': 'https://www.hbftextiles.com/about/showrooms',
      'target': '_blank'
    });
    $('li.Visit.HBF a').attr({
      'href': 'https://www.hbf.com/',
      'target': '_blank'
    });
  }
